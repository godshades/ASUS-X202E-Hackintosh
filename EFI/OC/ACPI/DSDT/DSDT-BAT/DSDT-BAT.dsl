 ...
 *
 * Disassembly of iASLihYpdd.aml, Sat Apr 17 18:02:05 2021
 *
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (BIFA, 0, NotSerialized)
        {
            If (ECAV ())
            {
                ...
                Else
                {
                    Local0 = B1B2(\_SB_.PCI0.LPCB.EC0_.B0S0,\_SB_.PCI0.LPCB.EC0_.B0S1) /* \_SB_.PCI0.LPCB.EC0_.B0SN */
                }
            }
            Else
            {
        ...
        Method (TACH, 1, Serialized)
        {
            If (ECAV ())
            {
                Switch (Arg0)
                {
                    Case (Zero)
                    {
                        Local0 = B1B2(\_SB_.PCI0.LPCB.EC0_.AH00,\_SB_.PCI0.LPCB.EC0_.AH01) /* \_SB_.PCI0.LPCB.EC0_.TAH0 */
                        Break
                    }
                    Case (One)
                    {
                        Local0 = B1B2(\_SB_.PCI0.LPCB.EC0_.AH10,\_SB_.PCI0.LPCB.EC0_.AH11) /* \_SB_.PCI0.LPCB.EC0_.TAH1 */
                        Break
                    }
                    Default
                    {
